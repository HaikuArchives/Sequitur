...
#ifndef ARPSUPPORT_ARPINTTOSTRINGMAPI_H
...
public:
	...
	virtual status_t	IdForIndex(		int32 index, int32 *answer) const;
	virtual status_t	IdForName(		const BString16 *name, int32 *answer) const = 0;

	virtual status_t	IndexForId(		int32 id, int32 *answer) const;
	virtual status_t	IndexForName(	const BString16 *name, int32 *answer) const;

	virtual status_t	NameForId(		int32 id, BString16 *answer) const = 0;
	virtual status_t	NameForIndex(	int32 index, BString16 *answer) const;
