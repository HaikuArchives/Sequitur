 ...
 *****************************************************************************/
class ArpKeyboardSplitterAddOn;

class ArpKeyboardSplitterFilter : public AmFilterI
{
public:
	ArpKeyboardSplitterFilter(	ArpKeyboardSplitterAddOn* addon,
								AmFilterHolderI* holder,
								const BMessage* settings);
	~ArpKeyboardSplitterFilter();
...
private:
	ArpKeyboardSplitterAddOn*	mAddOn;
 ...
 *****************************************************************************/
class ArpKeyboardSplitterAddOn : public AmFilterAddOn
{
public:
	ArpKeyboardSplitterAddOn(const void* cookie);
	
	virtual VersionType Version(void) const				{ return VERSION_CURRENT; }
	virtual BString		Name() const					{ return "Keyboard Splitter"; }
	virtual BString		Key() const						{ return "arp:KeyboardSplitter"; }
	...
	virtual AmFilterI*	NewInstance(AmFilterHolderI* holder,
		...
		{ return new ArpKeyboardSplitterFilter(this, holder, config); }
};
